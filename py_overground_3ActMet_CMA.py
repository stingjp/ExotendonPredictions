...
# TreadmillModel = 'strong_mk14_rv1_dgf_kneedampremoved.osim'
TreadmillModel = 'strong_mk15_rv1_dgf_kneedampremoved.osim'
...
premetmodel.printToXML('strong_mk14_post.osim')
...
gaitTrackingSolution.write(resultspath + '3CMA_nat_2D3D_OG_muscles_Tracking_solution__Halfgaitcycle.sto');
# gaitTrackingSolution.write('./results/1_nat_muscles_Tracking_solution__Halfgaitcycle.sto');
# % keyboard
# gaitTrackingSolution = osim.MocoTrajectory(resultspath + '3CMA_nat_2D3D_OG_muscles_Tracking_solution__Halfgaitcycle.sto')
# testobj = 5
...
fullStride.write(resultspath + './3CMA_nat_2D3D_OG_muscles_Tracking_solution_FullStride.sto');
# write a controls file as well
osim.STOFileAdapter.write(fullStride.exportToControlsTable(), resultspath + '3CMA_nat_controls.sto')
...
osim.STOFileAdapter.write(table_vel, resultspath + '3CMA_nat_quickAnalysis_Normalized_Fiber_Velocity.sto')
...
osim.STOFileAdapter.write(table_len, resultspath + '3CMA_nat_quickAnalysis_Normalized_Fiber_Length.sto')
...
osim.STOFileAdapter.write(table_probe, resultspath + '3CMA_nat_quickAnalysis_metabolics.sto')
...
osim.STOFileAdapter.write(table_tenvel, resultspath + '3CMA_nat_quickAnalysis_tendon_velocity.sto')
...
osim.STOFileAdapter.write(table_mtu, resultspath + '3CMA_nat_quickAnalysis_mtu.sto')
...
osim.STOFileAdapter.write(table_pass, resultspath + '3CMA_nat_quickAnalysis_passive_fiber_force.sto')
...
osim.STOFileAdapter.write(table_activ, resultspath + '3CMA_nat_quickAnalysis_active_fiber_force.sto')
...
osim.STOFileAdapter.write(table_head.flatten(), resultspath + '3CMA_nat_quickAnalysis_head_pos.sto') 
...
osim.STOFileAdapter.write(table_ToeL.flatten(), resultspath + '3CMA_nat_quickAnalysis_bigToeL_pos.sto')
...
osim.STOFileAdapter.write(table_ToeR.flatten(), resultspath + '3CMA_nat_quickAnalysis_bigToeR_pos.sto')
...
osim.STOFileAdapter.write(table_probeind, resultspath + '3CMA_nat_quickAnalysis_metabolics_individuals.sto')
...
osim.STOFileAdapter.write(table_jointMoments, resultspath + '3CMA_nat_quickAnalysis_joint_moments.sto');
...
table_mtu = study.analyze(fullStride, analyzeStrings_mtu); 
osim.STOFileAdapter.write(table_mtu, resultspath + '3CMA_nat_quickAnalysis_all.sto')
...
osim.STOFileAdapter.write(externalForcesTableFlat, 
                             resultspath + './3CMA_nat_2D3D_OG_muscles_Tracking_solutionGRF_FullStride.sto');
fullstrideGRF = fullStride;
fullstrideGRF.insertStatesTrajectory(externalForcesTableFlat);
fullstrideGRF.write(resultspath + './3CMA_nat_2D3D_OG_muscles_Tracking_solution_fullStride_wGRF.sto');
...
#                                             x, tag, modelmass, resultspath)
# generate a report
output = resultspath + '3CMA_nat_report.pdf'
report = osim.report.Report(model,
                            resultspath + '3CMA_nat_2D3D_OG_muscles_Tracking_solution_fullStride_wGRF.sto',
                            bilateral=True,
                            output=output)
...
if comparisonreport:
    ...
    # out2 = resultspath + '3ActMet_3exoActMet_compare_report.pdf'
    out2 = resultspath + '3CMA_nat_Naturaltight_compare_report.pdf'
    # ref_files = [
    #         './results/2.7/648/3exoActMet_2D3D_OG_muscles_Tracking_solution_FullStride.sto',
    #         './results/2.7/648/3exoActMet_controls.sto']
    ref_files = [
            './goodresults/27ms_mk13_poly5/015_3ActMet_6835_extraTight/3ActMet_2D3D_OG_muscles_Tracking_solution_FullStride.sto',
            './goodresults/27ms_mk13_poly5/015_3ActMet_6835_extraTight/3ActMet_controls.sto']
    report = osim.report.Report(model,
                                    resultspath + '3CMA_nat_2D3D_OG_muscles_Tracking_solution_FullStride.sto',
...
if comparisonreport:
    print(comparisonreport)
    # out2 = resultspath + '3CMA_nat_3exoActMet_compare_report.pdf'
    out2 = resultspath + '3CMA_nat_NaturalIK_compare_report.pdf'
    # ref_files = [
    #         './results/2.7/648/3exoActMet_2D3D_OG_muscles_Tracking_solution_FullStride.sto',
    #         './results/2.7/648/3exoActMet_controls.sto']
    ref_files = [
            './expData/2D2Darms/27_IK_nat_FullStride.sto',
            './expData/2D2Darms/27_IK_nat_controls.sto']
    report = osim.report.Report(model,
                                    resultspath + '3CMA_nat_2D3D_OG_muscles_Tracking_solution_FullStride.sto',
                                    output=out2, bilateral=True,
                                    ref_files=ref_files)
