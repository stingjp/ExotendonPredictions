...
trackedfile = './4CMA_exo_long_compliant_2D3D_muscle_GaitTracking_tracked_states.sto'
...
track.setName('4CMA_exo_long_compliant_2D3D_muscle_GaitTracking');
...
gaitTrackingSolution.write(resultspath + '4CMA_exo_long_compliant_2D3D_OG_muscles_Tracking_solution__Halfgaitcycle.sto');
# gaitTrackingSolution.write('./results/1_nat_muscles_Tracking_solution__Halfgaitcycle.sto');
# % keyboard
# gaitTrackingSolution = osim.MocoTrajectory(resultspath + '4CMA_exo_long_compliant_2D3D_OG_muscles_Tracking_solution__Halfgaitcycle.sto')
# testobj = 5
...
fullStride.write(resultspath + './4CMA_exo_long_compliant_2D3D_OG_muscles_Tracking_solution_FullStride.sto');
# write a controls file as well
osim.STOFileAdapter.write(fullStride.exportToControlsTable(), resultspath + '4CMA_exo_long_compliant_controls.sto')
...
osim.STOFileAdapter.write(table_vel, resultspath + '4CMA_exo_long_compliant_quickAnalysis_Normalized_Fiber_Velocity.sto')
...
osim.STOFileAdapter.write(table_len, resultspath + '4CMA_exo_long_compliant_quickAnalysis_Normalized_Fiber_Length.sto')
...
osim.STOFileAdapter.write(table_probe, resultspath + '4CMA_exo_long_compliant_quickAnalysis_metabolics.sto')
...
osim.STOFileAdapter.write(table_tenvel, resultspath + '4CMA_exo_long_compliant_quickAnalysis_tendon_velocity.sto')
...
osim.STOFileAdapter.write(table_mtu, resultspath + '4CMA_exo_long_compliant_quickAnalysis_mtu.sto')
...
osim.STOFileAdapter.write(table_pass, resultspath + '4CMA_exo_long_compliant_quickAnalysis_passive_fiber_force.sto')
...
osim.STOFileAdapter.write(table_activ, resultspath + '4CMA_exo_long_compliant_quickAnalysis_active_fiber_force.sto')
...
osim.STOFileAdapter.write(table_head.flatten(), resultspath + '4CMA_exo_long_compliant_quickAnalysis_head_pos.sto') 
...
osim.STOFileAdapter.write(table_ToeL.flatten(), resultspath + '4CMA_exo_long_compliant_quickAnalysis_bigToeL_pos.sto')
...
osim.STOFileAdapter.write(table_ToeR.flatten(), resultspath + '4CMA_exo_long_compliant_quickAnalysis_bigToeR_pos.sto')
...
osim.STOFileAdapter.write(table_probeind, resultspath + '4CMA_exo_long_compliant_quickAnalysis_metabolics_individuals.sto')
...
osim.STOFileAdapter.write(table_jointMoments, resultspath + '4CMA_exo_long_compliant_quickAnalysis_joint_moments.sto');
...
osim.STOFileAdapter.write(table_exoten, resultspath + '4CMA_exo_long_compliant_quickAnalysis_HOBL.sto')

analyzeStrings_mtu = osim.StdVectorString(); 
analyzeStrings_mtu.append('.*'); 
table_mtu = study.analyze(fullStride, analyzeStrings_mtu); 
osim.STOFileAdapter.write(table_mtu, resultspath + '4CMA_exo_long_compliant_quickAnalysis_all.sto')
...
osim.STOFileAdapter.write(table_ma, resultspath + '4CMA_exo_long_compliant_quickAnalysis_moment_arms.sto')
...
osim.STOFileAdapter.write(externalForcesTableFlat, 
                             resultspath + './4CMA_exo_long_compliant_2D3D_OG_muscles_Tracking_solutionGRF_FullStride.sto');
fullstrideGRF = fullStride;
fullstrideGRF.insertStatesTrajectory(externalForcesTableFlat);
fullstrideGRF.write(resultspath + './4CMA_exo_long_compliant_2D3D_OG_muscles_Tracking_solution_fullStride_wGRF.sto');


print('\n\nchange wantguess to True if we want to overwrite the guess to this solution!')
print('gaitTrackingSolution to fullstrideGRF:  \n4CMA_exo_long_compliant_2D3D_OG_muscles_Tracking_solution_fullStride_wGRF.sto\n')
...
#                                             x, tag, modelmass, resultspath)
# generate a report
output = resultspath + '4CMA_exo_long_compliant_report.pdf'
report = osim.report.Report(model,
                            resultspath + '4CMA_exo_long_compliant_2D3D_OG_muscles_Tracking_solution_fullStride_wGRF.sto',
                            bilateral=True,
                            output=output)
...
if comparisonreport:
    ...
    out2 = resultspath + '4CMA_exo_long_compliant_Naturaltight_compare_report.pdf'
    # ref_files = [
    ...
    report = osim.report.Report(model,
                                    resultspath + '4CMA_exo_long_compliant_2D3D_OG_muscles_Tracking_solution_FullStride.sto',
...
if comparisonreport:
    print(comparisonreport)
    # out2 = resultspath + '4CMA_exo_long_compliant_3exoActMet_compare_report.pdf'
    out2 = resultspath + '4CMA_exo_long_compliant_NaturalIK_compare_report.pdf'
    # ref_files = [
    #         './results/2.7/648/3exoActMet_2D3D_OG_muscles_Tracking_solution_FullStride.sto',
    #         './results/2.7/648/3exoActMet_controls.sto']
    ref_files = [
