...
trackedfile = './3CMA_exo_long2_2D3D_muscle_GaitTracking_tracked_states.sto'
...
track.setName('3CMA_exo_long2_2D3D_muscle_GaitTracking');
...
# TreadmillModel = 'strong_mk14_rv1_dgf_kneedampremoved_exo_long2.osim'
TreadmillModel = 'strong_mk15_rv1_dgf_kneedampremoved_exo_long2.osim'
...
premetmodel.printToXML('strong_mk14_exo_long2_post.osim')
...
gaitTrackingSolution.write(resultspath + '3CMA_exo_long2_2D3D_OG_muscles_Tracking_solution__Halfgaitcycle.sto');
...
fullStride.write(resultspath + './3CMA_exo_long2_2D3D_OG_muscles_Tracking_solution_FullStride.sto');
# write a controls file as well
osim.STOFileAdapter.write(fullStride.exportToControlsTable(), resultspath + '3CMA_exo_long2_controls.sto')
...
osim.STOFileAdapter.write(table_vel, resultspath + '3CMA_exo_long2_quickAnalysis_Normalized_Fiber_Velocity.sto')
...
osim.STOFileAdapter.write(table_len, resultspath + '3CMA_exo_long2_quickAnalysis_Normalized_Fiber_Length.sto')
...
osim.STOFileAdapter.write(table_probe, resultspath + '3CMA_exo_long2_quickAnalysis_metabolics.sto')
...
osim.STOFileAdapter.write(table_tenvel, resultspath + '3CMA_exo_long2_quickAnalysis_tendon_velocity.sto')
...
osim.STOFileAdapter.write(table_mtu, resultspath + '3CMA_exo_long2_quickAnalysis_mtu.sto')
...
osim.STOFileAdapter.write(table_pass, resultspath + '3CMA_exo_long2_quickAnalysis_passive_fiber_force.sto')
...
osim.STOFileAdapter.write(table_activ, resultspath + '3CMA_exo_long2_quickAnalysis_active_fiber_force.sto')
...
osim.STOFileAdapter.write(table_head.flatten(), resultspath + '3CMA_exo_long2_quickAnalysis_head_pos.sto') 
...
osim.STOFileAdapter.write(table_ToeL.flatten(), resultspath + '3CMA_exo_long2_quickAnalysis_bigToeL_pos.sto')
...
osim.STOFileAdapter.write(table_ToeR.flatten(), resultspath + '3CMA_exo_long2_quickAnalysis_bigToeR_pos.sto')
...
osim.STOFileAdapter.write(table_probeind, resultspath + '3CMA_exo_long2_quickAnalysis_metabolics_individuals.sto')
...
osim.STOFileAdapter.write(table_jointMoments, resultspath + '3CMA_exo_long2_quickAnalysis_joint_moments.sto');
...
osim.STOFileAdapter.write(table_exoten, resultspath + '3CMA_exo_long2_quickAnalysis_HOBL.sto')

analyzeStrings_mtu = osim.StdVectorString(); 
analyzeStrings_mtu.append('.*'); 
table_mtu = study.analyze(fullStride, analyzeStrings_mtu); 
osim.STOFileAdapter.write(table_mtu, resultspath + '3CMA_exo_long2_quickAnalysis_all.sto')
...
osim.STOFileAdapter.write(table_ma, resultspath + '3CMA_exo_long2_quickAnalysis_moment_arms.sto')
...
osim.STOFileAdapter.write(externalForcesTableFlat, 
                             resultspath + './3CMA_exo_long2_2D3D_OG_muscles_Tracking_solutionGRF_FullStride.sto');
fullstrideGRF = fullStride;
fullstrideGRF.insertStatesTrajectory(externalForcesTableFlat);
fullstrideGRF.write(resultspath + './3CMA_exo_long2_2D3D_OG_muscles_Tracking_solution_fullStride_wGRF.sto');


print('\n\nchange wantguess to True if we want to overwrite the guess to this solution!')
print('gaitTrackingSolution to fullstrideGRF:  \n3CMA_exo_long2_2D3D_OG_muscles_Tracking_solution_fullStride_wGRF.sto\n')
...
#                                             x, tag, modelmass, resultspath)
# generate a report
output = resultspath + '3CMA_exo_long2_report.pdf'
report = osim.report.Report(model,
                            resultspath + '3CMA_exo_long2_2D3D_OG_muscles_Tracking_solution_fullStride_wGRF.sto',
                            bilateral=True,
                            output=output)
...
if comparisonreport:
    ...
    out2 = resultspath + '3CMA_exo_long2_Exotight_compare_report.pdf'
    # ref_files = [
    ...
    report = osim.report.Report(model,
                                    resultspath + '3CMA_exo_long2_2D3D_OG_muscles_Tracking_solution_FullStride.sto',
...
if comparisonreport:
    ...
    out2 = resultspath + '3CMA_NatVSExo_long2_compare_report.pdf'
    # ref_files = [
...
if comparisonreport:
    ...
    out2 = resultspath + '3CMA_exo_long2_ExoIK_compare_report.pdf'
    # ref_files = [
    #         './results/2.7/648/3exoActMet_2D3D_OG_muscles_Tracking_solution_FullStride.sto',
    #         './results/2.7/648/3exoActMet_controls.sto']
    ref_files = [
